...
export const processSteps = [
  {
    ...
    description:
      "We start by inspecting your bins to determine the level of dirt, grime, and odor. Please ensure that all trash is removed from the bin prior to service appointment.",
  },
  {
    id: 2,
    ...
    title: "Pre-Treatment",
    description:
      "Next, we apply an eco-friendly, biodegradable degreasing cleaning solution to break down tough grease and grime.",
  },
  {
    id: 3,
    ...
    description:
      "Using state-of-the-art equipment, we pressure wash the inside and outside of your bins with hot water, reaching temperatures up to 200°F. This ensures a deep clean, removing all debris, bacteria, and odors.",
  },
  {
    id: 4,
    ...
    title: "Deodorization",
    description:
      "Finally, we apply a deodorizing solution to leave your bins smelling fresh and pleasant.",
  },
  {
    id: 5,
    ...
    description:
      "We conduct a final inspection to ensure your bins meet our high standard of cleanliness and sanitation.",
  },
  {
    id: 6,
    icon: returnIcon,
    ...
    description:
      "We will return bins to the side of the garage or in front of the gate if that is where they were retrieved from. If bins were left on the street for us to service, bins will be taken up to the garage or gate as well.",
  },
  {
    id: 7,
    icon: billingIcon,
